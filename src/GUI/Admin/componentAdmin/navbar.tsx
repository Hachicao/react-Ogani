        ...
        <div className="navbar-header">
          ...
          <div className="top-left-part">
            <a className="logo " href="index.html">
              <b>
                <img
                  src="/assest/plugins/images/eliteadmin-logo.png"
                  alt="home"
                  className="dark-logo inline"
                />
                <img
                  src="/assest/plugins/images/eliteadmin-logo-dark.png"
                  alt="home"
                  className="light-logo inline"
                />
              </b>
              <span className="hidden-xs">
                <img
                  src="/assest/plugins/images/eliteadmin-text.png"
                  alt="home"
                  className="dark-logo inline"
                />
                <img
                  src="/assest/plugins/images/eliteadmin-text-dark.png"
                  alt="home"
                  className="light-logo inline"
                />
              </span>
                  ...
                  <div className="message-center">
                    <a href="#">
                      <div className="user-img">
                        {" "}
                        <img
                          src="assest/plugins/images/users/pawandeep.jpg"
                          alt="user"
                    ...
                    <a href="#">
                      <div className="user-img">
                        {" "}
                        <img
                          src="assest/plugins/images/users/sonu.jpg"
                          alt="user"
                          className="img-circle"
                        />{" "}
                    ...
                    <a href="#">
                      <div className="user-img">
                        {" "}
                        <img
                          src="assest/plugins/images/users/arijit.jpg"
                          alt="user"
                          className="img-circle"
                        />{" "}
                ...
                <li className="col-sm-12 m-t-40 demo-box">
                  <div className="row">
                    <div className="col-sm-2">
                      <div className="white-box text-center bg-purple">
                        <a
                    ...
                    <div className="col-sm-2">
                      <div className="white-box text-center bg-success">
                        <a
                    ...
                    <div className="col-sm-2">
                      <div className="white-box text-center bg-info">
                        <a
                    ...
                    <div className="col-sm-2">
                      <div className="white-box text-center bg-inverse">
                        <a
                    ...
                    <div className="col-sm-2">
                      <div className="white-box text-center bg-warning">
                        <a
                    ...
                    <div className="col-sm-2">
                      <div className="white-box text-center bg-danger">
                        <a
                        ...
                        >
                          <i
                            className="linea-icon linea-ecommerce fa-fw"
                            data-icon="d"
                          ></i>
                          <br />
                          Buy Now
